...
month = int(config_data["month"])
day = int(config_data["day"])
hour = int(config_data["hour"])
minute = int(config_data["minute"])
...
food_shop_item_max = config_data["food_shop_item_max"]
food_shop_type_max = config_data["food_shop_type_max"]
