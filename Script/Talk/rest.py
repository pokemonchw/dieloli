...
@talk.add_talk(constant.Behavior.REST,1,{"IsPlayer"})
...
@talk.add_talk(constant.Behavior.REST,2,{"NoPlayer","InPlayerScene"})
...
@talk.add_talk(constant.Behavior.REST,3,{"IsPlayer","HaveTarget"})
