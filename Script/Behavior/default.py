...
@character_behavior.add_behavior("Default",constant.CharacterStatus.STATUS_ARDER)
...
@character_behavior.add_behavior("Default",constant.CharacterStatus.STATUS_MOVE)
def move_behavior(character_id:int):
    ...
    if character_data.position == character_data.behavior["MoveTarget"]:
        ...
        character_data.behavior["BehaviorId"] = constant.CharacterStatus.STATUS_ARDER
        ...
        end_time = game_time.get_sub_date(character_data.behavior["Duration"],old_date=game_time.datetime_to_game_time(start_time))
        time_judge = game_time.judge_date_big_or_small(game_time.datetime_to_game_time(end_time),cache_contorl.game_time)
