...
def handle_let_all_students_study_in_classroom(
    ...
    """
    让教室内所有本班学生进入学习状态 (计划废弃，将由 Session 接管)
    """
    pass


@settle_behavior.add_settle_behavior_effect(constant.BehaviorEffect.UPDATE_SOCIAL_SESSION)
def handle_update_social_session(
    character_id: int,
    add_time: int,
    change_data: game_type.CharacterStatusChange,
    now_time: int,
    ...
    """
    更新社交场会话状态 (已废弃，由 session_handler 接管)
    """
    pass
