...
class PremiseMenu(QWidget):
        ...
        for type_list in range_list:
            ...
            for now_type in type_list:
                ...
                for premise in premise_list:
                    ...
                    if premise in cache_control.now_target_data[cache_control.now_target_id].premise:
    ...
    def click_item(self, item: TreeItem, column: int):
        ...
        if item.checkState(column) == Qt.Checked:
            ...
            if item.cid in cache_control.now_target_data[cache_control.now_target_id].premise:
                del cache_control.now_target_data[cache_control.now_target_id].premise[item.cid]
        else:
